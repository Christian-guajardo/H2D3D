...
public class ConnectView extends JPanel {
    ...
    public ConnectView() {
        ...
        listPanel.setBackground(new Color(0xFF474747, true));
    ...
    private JPanel createUserRow(User user) {
        ...
        // Avatar (initiale simple)
        JLabel avatar = new JLabel(getInitials(user));
        avatar.setOpaque(true);
        avatar.setBackground(new Color(0x2F80ED)); // bleu
        ...
        // Click listener pour la ligne entière
        row.addMouseListener(new MouseAdapter() {

            @Override
            public void mouseEntered(MouseEvent e) {
                row.setBackground(new Color(0xFF666666, true));
            }
    ...
    private String getInitials(User user) {
        ...
        String s = ("" + parts[0].charAt(0) + parts[parts.length-1].charAt(0)).toUpperCase();
        return s;
    }
